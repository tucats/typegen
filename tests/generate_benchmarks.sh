...
./typegen -f tests/test7.json -o tests/test7.go_benchmark
./typegen -f tests/test8.json -o tests/test8.go_benchmark
...
./typegen -f tests/test7.json -o tests/test7.swift_benchmark -l swift
./typegen -f tests/test8.json -o tests/test8.swift_benchmark -l swift
